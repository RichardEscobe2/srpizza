                    ...
                    <table class="table table-dark table-hover mb-0">
                        ...
                        <tbody>
                            @forelse($pedidos as $ped)
                                <tr>
                                    <td class="fw-bold text-warning">Mesa {{ $ped->numero_mesa }}</td>
                                    <td>{{ $ped->estado }}</td>
        ...
        <div class="col-md-7">
            <div class="panel-cuenta shadow">
                ...
                @if($pedidoSeleccionado)
                    <h6 class="text-warning mb-3">MESA {{ DB::table('mesas')->where('mesa_id', $pedidoSeleccionado->mesa_id)->value('numero_mesa') }} | Orden #{{ $pedidoSeleccionado->pedido_id }}</h6>
